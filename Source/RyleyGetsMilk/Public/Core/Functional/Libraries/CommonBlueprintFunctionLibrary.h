...
public:
	...
	static void LineTraceInFrontOfActor(AActor* Actor, FVector Offset, float Distance,
	...
	UFUNCTION(BlueprintCallable, Category="Tracing")
	static void LineTraceInFrontOfObject(USceneComponent* Component, FVector Offset, float Distance,
								FRotator Orientation, ETraceTypeQuery TraceChannel, TArray<AActor*> Ignored, bool bTraceComplex, bool bShowHits,
								TArray<FHitResult>& Hits, FHitResult& FirstHit, bool& bDidHit);
